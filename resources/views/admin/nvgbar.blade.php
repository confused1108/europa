                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="admin_details.php" class="btn btn-default btn-flat">Profile</a>
                            </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="workers.php"><i class="fa fa-circle-o"></i>Workers</a>
                    </li>
                    <li><a href="subadmins.php"><i class="fa fa-circle-o"></i>Subadmins</a></li>
                    <li><a href="add_region.php"><i class="fa fa-circle-o"></i>Regions</a></li>
                    <li><a href="stores.php"><i class="fa fa-circle-o"></i>Stores</a>
                    </li>
                    <li><a href="wardens.php"><i class="fa fa-circle-o"></i>Wardens</a>
                    </li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="complaints_table.php"><i class="fa fa-circle-o"></i> Complaints Table</a></li>
